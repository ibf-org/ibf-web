...
export default function SignUpPage() {
  return (
    <div className="flex min-h-screen bg-[var(--ibf-bg)] font-['Bricolage_Grotesque',sans-serif]">
      ...
      <div className="hidden lg:flex w-1/2 bg-[var(--ibf-secondary)] flex-col justify-between p-12 relative overflow-hidden">
        {/* Background blobs */}
        <div className="absolute top-[-100px] left-[-100px] w-96 h-96 bg-[#0F766E] rounded-full blur-[80px] opacity-40"></div>
        <div className="absolute bottom-[20%] right-[-100px] w-96 h-96 bg-[#14B8A6] rounded-full blur-[80px] opacity-30"></div>
        ...
        >
          <h1 className="font-['Instrument_Serif',serif] italic italic text-[56px] leading-[1.05] text-ibf-heading tracking-tight mb-6">
            Join the collective.<br />Start building.
          </h1>
          <p className="font-['Bricolage_Grotesque',sans-serif] text-[16px] text-ibf-heading/90 font-light max-w-md leading-relaxed">
            Create an account to join projects, find technical co-founders, and expand your portfolio with real-world problems.
          </p>
        </motion.div>
      </div>
