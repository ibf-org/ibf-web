...
export default function SignUpPage() {
  return (
    <div className="flex min-h-screen bg-[#FAFAF7] font-sans">
      ...
      <div className="hidden lg:flex w-1/2 bg-[#0D9488] flex-col justify-between p-12 relative overflow-hidden">
        {/* Background blobs */}
        ...
        >
          ...
          <p className="font-sans text-[16px] text-white/90 font-light max-w-md leading-relaxed">
