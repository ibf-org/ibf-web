...
const statusConfig: Record<string, { dotClass: string; badgeClass: string; label: string }> = {
  ...
  closed:    { dotClass: 'bg-gray-400',    badgeClass: 'border-gray-400/30 bg-gray-500/15 text-ibf-muted',        label: 'Closed' },
  pending:   { dotClass: 'bg-blue-400',    badgeClass: 'border-blue-400/30 bg-blue-500/15 text-ibf-primary',        label: 'Pending' },
...
const fallback = { dotClass: 'bg-gray-400', badgeClass: 'border-gray-400/30 bg-gray-500/15 text-ibf-muted', label: '' }
